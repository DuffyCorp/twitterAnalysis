...
model = keras.models.load_model('emotionAnalysis2/output1/model.h5')

f = open('emotionAnalysis2/output1/tokenizer.pkl', 'rb')
tokenizer = pickle.load(f)
f.close()

f = open('emotionAnalysis2/output1/encoder.pkl', 'rb')
...
def emotionAnalysis(text):
    ...
    return {"label": result, "score": float(score),
